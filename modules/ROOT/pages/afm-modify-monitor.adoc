...
You can modify monitors via the Functional Monitoring UI, which includes the options to edit the monitor as text fields or to edit the monitor as BAT source. You can also download the montor, edit the monitor in your text editor of choice, and then upload the monitor.
