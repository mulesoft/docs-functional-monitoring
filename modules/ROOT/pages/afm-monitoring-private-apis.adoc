...
IMPORTANT: In early versions of private locations, for tests to run, you had to allow incoming HTTP traffic into the private location's environment. If you xref:update-private-locations[update your private location], you'll no longer need to allow incoming HTTP traffic.
