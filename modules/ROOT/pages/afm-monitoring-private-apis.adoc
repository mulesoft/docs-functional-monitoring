...
+
Monitor 3 runs on two separate schedules, Schedule D and Schedule E, and each is associated with a different private location. Monitor 3 is written to test one or more endpoints in API 5 and in API 6, although it could also test endpoints in more private APIs. The private locations and APIs are in a single environment, environment A.
+
