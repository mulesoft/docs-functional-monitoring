...
You can mask sensitive information in monitors that you run in a private location. You can mask headers, token values, username and password, and body values.
