...
The list of schedules that use the private location appears within the location's entry. For each schedule, the following information appears:

* The monitor that the schedule belongs to
* The intervals at which the schedule runs the test in the monitor
