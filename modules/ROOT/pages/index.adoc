...
Developers and operators can use API Functional Monitoring to perform consistent testing of the functional behavior and performance of their APIs throughout the API lifecycle, in testing and production environments.
