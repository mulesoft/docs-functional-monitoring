...
You can also use the `bat` command to manage cloud integration and to schedule and configure tests and monitors using Anypoint Platform. Following are the subcommands you can use as part of a `bat` command or in the `bat` interactive mode.
