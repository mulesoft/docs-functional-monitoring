...
* `--help`
+
Displays information on how to use the command, including a list of available options.
...
You can also use the `bat` command to manage cloud integration and to schedule and configure tests and monitors using Anypoint Platform. Following are the subcommands you can use as part of a `bat` command or in the `bat` command interactive mode.
