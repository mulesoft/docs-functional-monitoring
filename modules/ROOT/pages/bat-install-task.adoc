...
Click https://repository-master.mulesoft.org/nexus/content/repositories/releases/com/mulesoft/bat/bat-wrapper/1.1.14/bat-wrapper-1.1.14.zip[here^] to download the BAT wrapper for Windows. After it downloads, unzip it to install it in your Windows environment.  
