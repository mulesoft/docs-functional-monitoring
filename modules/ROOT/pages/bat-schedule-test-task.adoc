...
. Go to Exchange and take a look at the asset named after the monitor URL that you provided in the `bat schedule endpoint` command. It is `+http://www.example.com+` in this example. 
