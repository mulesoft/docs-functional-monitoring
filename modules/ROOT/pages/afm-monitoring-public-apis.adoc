...
Number of Schedules::
+
Initially, AFM lets your organization in Anypoint Platform run up to five schedules for testing from public locations at one time. If you reach the limit of five schedules and want to run more moniors simultaneously, contact your MuleSoft administrator about raising your maximum.
