...
The following diagram depicts the types of relationships monitors of public APIs can have with their schedules, public locations, APIs, and environments. The different line types depict the different types of relationships.
...
+
. Monitor 5's relationships (represented by solid violet arrows): tests APIs in Cloudhub environments and on the web
+
