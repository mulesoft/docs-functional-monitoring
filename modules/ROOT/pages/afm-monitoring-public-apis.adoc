...
The following diagram depicts the types of relationships monitors of public APIs can have with their schedules, public locations, APIs, and environments. Each type of relationship is indicated with a unique line style.
...
+
. Monitor 5's relationships (indicated with solid violet arrows): tests APIs in Cloudhub environments and on the web
+
