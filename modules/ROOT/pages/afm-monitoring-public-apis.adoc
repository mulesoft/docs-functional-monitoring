...
+
Monitor 1 runs on a single schedule. The schedule is associated with Public Location 1. The monitor is written to test one or more endpoints in public API 1 and in public API 2, although it could also test endpoints in more public APIs. The two APIs are in a single environment, environment A.
+
