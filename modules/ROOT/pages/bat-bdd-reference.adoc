...
. Store the information (such as a password, authentication token, endpoint URL, webhook URL, or something else) as a shared secret in Anypoint Secrets Manager.
