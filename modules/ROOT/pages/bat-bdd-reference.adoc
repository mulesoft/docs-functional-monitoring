...
In your tests, you can access shared secrets that are symmetric key types from Anypoint Secrets Manager, which enables you to securely store sensitive information, such as a password, authentication token, endpoint URL, or webhook URL
