...
. In Anypoint Secrets Manager, create a shared secret as a symmetric key that uses Base64 encoding. If you choose not to create the shared secret as a symmetric key, then encode it in Base64.
