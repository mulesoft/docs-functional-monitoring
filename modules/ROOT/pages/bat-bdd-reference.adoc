...
* Functional Monitoring works only with symmetric key shared secret types. Using other types from Anypoint Secrets Monitor will cause all used shared secrets to stop being populated.
