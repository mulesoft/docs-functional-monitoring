...
Because reports are emailed only for tests created in or uploaded to the API Functional Monitoring in Anypoint Platform, after you create the add the reporters to your test in BAT CLI, upload the test. You can alternatively add the email reporting tool in the monitor's *Notifications* tab after you upload the test.
