...
Using New Relic with API Functional Monitoring, you can view metrics from test suites in the New Relic UI. Metrics include the times of each test, performance losses detected, and alert schedules.
