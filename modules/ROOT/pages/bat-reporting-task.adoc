...
a. In Anypoint Secrets Manager, create a shared secret as a symmetric key that uses Base64 encoding.
...
c. At a command prompt, run the `bat grant` command, specifying an alias for the shared secret.
