...
When using the Anypoint Platform you can create an email reporter to enable email alerts to several accounts.

_This option is only available in the Anypoint Platform since it uses the Anypoint Platform Alert Notification System._
...
The notification occurs in the case of a failure. And will provide the suite's name in which the error occurs and a list of the assertions.
