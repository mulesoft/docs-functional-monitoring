...
An Anypoint Platform administrator for your organization grants permission. See xref:access-management::managing-permissions[Manage Permissions].
...
* xref:access-management::managing-permissions[Manage Permissions]
