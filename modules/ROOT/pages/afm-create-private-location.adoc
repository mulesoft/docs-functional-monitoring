...
For information about what a private location is and why you might want to create one, see xref:afm-public-versus-private.adoc[Differences in the Monitoring of Public and Private APIs].
