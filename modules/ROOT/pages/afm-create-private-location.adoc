...
. Complete the creation of the of test or schedule. By default, it uses 0.2 vCores replica size.

NOTE: If your deployment target is set to any variant of CloudHub 2.0, a connected app is created automatically.
+
