...
====
. Find the entry for the location that you want to use. For public locations, the value of the `organizationId` field is `public`. For private locations, the value is your organization ID.
+
...
[NOTE]
====
This schedule uses the default interval of 15 minutes. If you want to use a different interval, see the
====
