...
== Result
Previous tests are still listed in the *Tests* section for the monitor, so that you can still view the data that is associated with them. You can also create new tests that are based on them.
