...
Although you cannot edit a test that you have already created for a monitor, you can create a new version of a test. In the new version, you can change, remove, or add assertions, headers, endpoints, and reporters.
