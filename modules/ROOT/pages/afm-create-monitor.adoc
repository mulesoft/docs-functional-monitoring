...
* Ensure that your user ID has the Monitoring Center User permission.
+
...
+
For details, see xref:afm-public-versus-private.adoc[Monitoring Public APIs Versus Monitoring Private Ones].
