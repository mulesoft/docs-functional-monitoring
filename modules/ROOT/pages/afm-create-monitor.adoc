...
. Populate the fields for each endpoint with the information gathered in "Before You Begin." Additionally, toggle *Validate SSL Certificate* to specify if the monitor needs to use self-signed certifications for an endpoint.
+
