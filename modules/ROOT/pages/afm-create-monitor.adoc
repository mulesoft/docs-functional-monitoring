...
. Populate the fields for each endpoint with the information gathered in "Before You Begin." If the monitor needs to use self-signed certifications for an endpoint, toggle *Validate SSL Certificate*.
+
