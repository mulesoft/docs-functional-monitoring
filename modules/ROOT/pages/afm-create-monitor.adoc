...
Click *Tests* to see statistics and information pertaining to the monitor. Because you have only one test in the monitor that you just created, the statistics and information in this section apply to the test, too.
