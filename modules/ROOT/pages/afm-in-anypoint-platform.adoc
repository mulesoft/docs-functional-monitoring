...
You can create more than one schedule per monitor test, as shown under the *Next run* column in the following image. A bar graph shows the daily average response time in milliseconds of all tests to all endpoints.
